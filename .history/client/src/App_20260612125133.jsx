...
// 1. Create your validation schema using Zod
const loginSchema = z.object({
  email: z.string().email({ message: "Invalid email address address" }),
  password: z.string().min(6, { message: "Password must be at least 6 characters" }),
});

export default function App() {
  // 2. Connect React Hook Form to your state tracker
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  // 3. Simple submission success handler
  const onSubmit = (data) => {
