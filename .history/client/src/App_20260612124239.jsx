...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-12 bg-slate-900 text-white p-6">
      <h1 className="text-3xl font-extrabold tracking-tight bg-linear-to-r from-teal-400 to-indigo-400 bg-clip-text text-transparent">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl w-full">
        ...
        <div className="flex flex-col items-center gap-4 rounded-2xl border border-slate-800 bg-slate-950 p-6 text-center shadow-xl">
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.9 }}
            className="h-24 w-24 rounded-2xl bg-linear-to-br from-teal-400 to-emerald-500 shadow-lg shadow-teal-500/20 cursor-pointer flex items-center justify-center font-bold text-slate-950"
          >
            Interact
          </motion.div>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 rounded-2xl border border-slate-800 bg-slate-950 p-6 text-center shadow-xl">
          ...
          <div
            ref={gsapBoxRef}
            className="h-24 w-24 rounded-2xl bg-linear-to-br from-indigo-500 to-purple-600 shadow-lg shadow-indigo-500/20 flex items-center justify-center font-bold text-white"
          >
            Spinning
          </div>
        </div>
