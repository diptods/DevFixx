      ...
      <header className="max-w-4xl mx-auto text-center px-4 pt-20 pb-16 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight mt-4 leading-tight">
            We Build High-Scale Systems For <span className="bg-linear-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent">Clothing & Wholesale Stores</span>
          </h1>
          ...
          <div className="mt-8 flex justify-center space-x-4">
            <a href="#contact" className="bg-linear-to-r from-teal-500 to-emerald-500 hover:from-teal-400 hover:to-emerald-400 text-slate-950 font-bold px-6 py-3 rounded-xl shadow-lg shadow-teal-500/10 transition-all text-sm uppercase tracking-wider">
              Launch Your Store
            </a>
